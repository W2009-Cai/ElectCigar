...
package com.xiaolanba.passenger.common.view.wheel;
...
import com.xiaolanba.passenger.common.view.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private int[] SHADOWS_COLORS = new int[] { 0xDDFFFFFF, 0x99FFFFFF, 0x4CFFFFFF };//0x99FFFFFF, 0x4cFFFFFF, 0x20FFFFFF
//	private int[] SHADOWS_COLORS = new int[] { 0xFFFFFF, 0xFFFFFF, 0xFFFFFF };
	...
	private void drawCenterRect(Canvas canvas) {
		...
		int offset = (int) (getItemHeight() / 2 * 1.08);
