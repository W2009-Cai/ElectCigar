...
public class ItemSlidingAnimator {
    ...
    private boolean slideToSpecifiedPositionInternal(
        ...
        if (position != 0.0f) {
            final View containerView = ((com.xiaolanba.passenger.library.advrecyclerview.swipeable.SwipeableItemViewHolder) holder).getSwipeableContainerView();
    ...
    private static class SlidingAnimatorListenerObject
        ...
        private void start() {
            final View containerView = ((com.xiaolanba.passenger.library.advrecyclerview.swipeable.SwipeableItemViewHolder) mViewHolder).getSwipeableContainerView();
        ...
        public void onAnimationEnd(View view) {
            ...
            if (mSwipeFinish != null && mSwipeFinish.resultAction != null) {
