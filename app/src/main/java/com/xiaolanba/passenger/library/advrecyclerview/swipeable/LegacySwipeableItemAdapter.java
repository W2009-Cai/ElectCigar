...
import com.xiaolanba.passenger.library.advrecyclerview.swipeable.annotation.SwipeableItemAfterReactions;
...
public interface LegacySwipeableItemAdapter<T extends RecyclerView.ViewHolder> extends BaseSwipeableItemAdapter<T> {
    ...
    /**
     * <p>Called after {@link #onSwipeItem(RecyclerView.ViewHolder, int, int)} method.</p>
