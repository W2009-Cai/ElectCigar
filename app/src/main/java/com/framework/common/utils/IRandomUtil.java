...
public class IRandomUtil {
    ...
    public static String getRandom(String source, int length) {
        return IStringUtil.isEmpty(source) ? null : getRandom(source.toCharArray(), length);
    }
     ...
     *
     * @param min
     * @param max nextInt不含最大的那个值,比如nextInt(20)返回[0,20)含0不含20
     */
    public static int getRandom(int min, int max) {
        ...
        return min + new Random().nextInt(max - min); //nextInt不含最大的那个值
    }
