...
public class AutoScrollVerticalViewPager extends VerticalViewPager {
    ...
    public interface OnPageClickListener {
        void onPageClick(AutoScrollVerticalViewPager pager, int position);
    }
    ...
    private boolean touchEventEnable = true;
    ...
    public AutoScrollVerticalViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onAttachedToWindow() {
        ...
        // TODO 在recyclerView 中滑动 viewpager 出现时又继续滚动
        if (autoScroll) {
            startAutoScroll();
        }
    }
...
//                if (lastSelectedPage != pos) {
                ...
                AutoScrollVerticalViewPager.this.post(new Runnable() {
                    @Override
                    public void run() {
