...
import com.framework.common.view.pulltorefresh.ILoadingLayout;
import com.framework.common.view.pulltorefresh.PullToRefreshBase.Mode;
import com.framework.common.view.pulltorefresh.PullToRefreshBase.Orientation;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	protected View mLoadingLayout , mloadingTxtLayout, mNoMoreLayout;
	...
	public LoadingLayout(Context context, final Mode mode, final Orientation scrollDirection, TypedArray attrs) {
		...
		mloadingTxtLayout = findViewById(R.id.loading_txt);
		mNoMoreLayout = findViewById(R.id.no_more_layout);
	...
	public void setNoMoreData(boolean noMore){
		mNoMoreData = noMore;
		mNoMoreLayout.setVisibility(noMore ? View.VISIBLE : View.GONE);
		mLoadingLayout.setVisibility(noMore ? View.GONE : View.VISIBLE);
		mloadingTxtLayout.setVisibility(noMore ? View.GONE : View.VISIBLE);
	}
...
//			}
	...
	public void setLastUpdatedLabel(CharSequence label) {
		//TODO
		if (mContext != null) {
//			setSubHeaderText(String.format(mContext.getString(R.string.pull_down_time_format), label));
		}
	}
