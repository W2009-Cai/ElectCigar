package com.xiaolanba.commonlib.fresco.photodraweeview;
...
public class PhotoDraweeView extends SimpleDraweeView implements IAttacher {
    ...
    public void setPhotoUri(Uri uri, BaseControllerListener<ImageInfo> listener) {
        setPhotoUri(uri, null, listener);
    }

    public void setPhotoUri(Uri uri, @Nullable Context context, final BaseControllerListener<ImageInfo> listener) {
